package br.com.factorymoney.api.service;
...
import br.com.factorymoney.api.mail.Mailer;
...
import br.com.factorymoney.api.repository.LancamentoRepository;
import br.com.factorymoney.api.repository.PessoaRepository;
import br.com.factorymoney.api.repository.UsuarioRepository;
...
public class LancamentoService {
	...
	public void avisarSobreLancamentosVencidos() {
		...
		if (destinatarios.isEmpty()) {
			logger.warn("Existem lançamentos vencidos mas o sistema não encontrou os destinatários");
			return;
		}
